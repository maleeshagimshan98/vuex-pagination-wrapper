...
describe('vuexStateWrapper Class', () => {
  ...
  describe('setData', () => {
    ...
    test('should overwrite existing data with the new data object', () => {
      ...
      const wrapper = new vuexStateWrapper(initialData);
